...
- `cargo rustics unused` — public-API reachability detector (Periphery-style BFS); reports public functions, structs, traits, type aliases, enum variants, methods, and consts whose name is referenced zero times outside its declaration.
