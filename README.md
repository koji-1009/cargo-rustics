...
* **Clippy** — lints (rule violations). rustics — *lenses* (quantitative dimensions). Roles are orthogonal. M2 will accept `cargo clippy --message-format=json` as one more lens via `--from-clippy`.
